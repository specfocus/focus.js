...
[![](https://cdn-images-1.medium.com/fit/c/120/120/1*TD1P0HtIH9zF0UEH28zYtw.png)](https://storybook.specfocus.com/?selectedKind=Table&full=0&addons=0&stories=1&panelRight=0) [![](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/specfocus/focus-sandbox?initialpath=/table&module=%2Fsrc%2FTable.js)
## Usage

```javascript
import { Table, TableHeader, TableFooter, TableBody, TableRow } from 'focus';
<Table />
```
