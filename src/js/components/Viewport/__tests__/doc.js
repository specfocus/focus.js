...
export const doc = Viewport => {
  const DocumentedGrommet = describe(Viewport)
    .availableAt(getAvailableAtBadge('Viewport'))
    .description('The top level Viewport container.')
    .usage(
...
<Viewport>...</Viewport>`,
  ...
  DocumentedGrommet.propTypes = {
    ...
    plain: PropTypes.bool
      .description(
        `Whether or not Viewport should apply a global font-family, font-size,
        and line-height.`,
      )
      .defaultValue(false),
...
export const themeDoc = {
  'viewport.extend': {
    description: 'Any additional style for Viewport.',
    type: 'string | (props) => {}',
